...
if (isset($_POST['tambah'])) {
    ...
    if (empty($name) || empty($stock) || empty($harga)) {
        ...
        if (itemAdd($random, $name, $stock, $harga)) {
    ...
    <div class="wr">
        ...
        <main>
                ...
                <div class="list">
                    <table>
                        ...
                        foreach ($items as $item) {
                            $format = convertCashFormat($item[3]);
                            echo "
                        <tr>
                        <td>$item[0]</td>
                        <td>$item[1]</td>
                        ...
                        <td><form method='post'>
                            ...
                            <a  class='btn-edit' href='/edit?id=$item[0]'>Edit</a>
            ...
            <div class="login2">
                <form method="post">
                    <h2>Tambah Barang</h2>
                    <input class="field" type="text" name="name" placeholder="Nama Barang">
                    <br />
                    <input class="field" type="number" name="stock" placeholder="Stock">
                    <br />
                    <input class="field" type="number" name="harga" placeholder="Harga">
